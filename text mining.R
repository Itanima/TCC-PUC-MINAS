...
print(p)
p + labs(title = "Text-Minig - Lucro Real/Presumido\nPeríodo: 2005 a 2019")  + xlab("Ocorrências") + ylab("contagem")
...
analise_mensagem %>%
  ...
  geom_col() +
  coord_flip() +
  labs(y = "Contribuição de cada ocorrência \n Empresas Lucro Real/Presumido - Período: 2005 a 2019")
...
p
p + labs(title = "Análise do motivo de encerramento", subtitle = "Empresas do Lucro Real/Presumido - Período: 2005 - 2019")
...
analise_mensagem %>%
  ...
  geom_col() +
  coord_flip() +
  labs(y = "Contribuição de cada ocorrência \n Empresas do Simples Nacional - Período: 2005 a 2019")
...
#        legend.justification = c(1, 0.5)) +
  labs(y = "Frequência de ocorrência",
       ...
       fill = "Frequência de\nocorrência")
p
p + labs(title = "Análise do motivo de encerramento", subtitle = "Empresas do Simples Nacional - Período: 2005 - 2019")
...
p <- ggplot(data = tb_bars,
  ...
  labs(y = "Frequência de ocorrência",
       ...
       fill = "Frequência de\nocorrência")
p
p + labs(title = "Análise do motivo de encerramento", subtitle = "Empresas do MEI - Período: 2005 - 2019")
