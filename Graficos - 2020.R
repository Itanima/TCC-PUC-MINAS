...
p
p + labs(title = "Quantitativo de Empresas abertas do Simples Nacional", subtitle = "Período: 2020")

p1 <- ggplot(MEI_AB, aes(x=UF, y=QTD)) + 
       geom_boxplot(aes(x = UF, y = QTD),color="orange", fill="orange", alpha=0.2)
p1
p1 + labs(title = "Quantitativo de Empresas abertas do MEI", subtitle = "Período: 2020")


p2 <- ggplot(LR_AB, aes(x=UF, y=QTD)) + 
      geom_boxplot(aes(x = UF, y = QTD),color="red", fill="red", alpha=0.2)
p2
p2 + labs(title = "Quantitativo de Empresas abertas do Lucro Real/Presumido", subtitle = "Período: 2020")
...
ggplot(data = dados) +
  ...
  labs(title="Opções por tipo de Tributação", subtitle="Período: 2020", 
...
ggplot(data = dados) +
  ...
  labs(title="Tempo de funciomamento", subtitle="Empresas do Simples Nacional",
       y="Quantidade de Estabelecimentos",x="Tempo de funcionamento", caption="Período: 2020") +
...
p1 <-ggplot(SN_AB, aes(ANO,UF)) +
  ...
  labs(title="Mapa de Calor - Empresas Abertas", subtitle="Empresas do Simples Nacional - Período: 2020") +
  ylab("Estado") +
...
p2 <-ggplot(LR_AB, aes(ANO,UF)) +
  ...
  scale_fill_gradient(low = "white", high = "yellowgreen") +
  labs(title="Mapa de Calor - Empresas Abertas", subtitle="Empresas do Lucro Real/Presumido - Período: 2020") +
  ylab("Estado") +
  xlab("Ano da Abertura") +
  theme(legend.title = element_text(size = 10),
        legend.text = element_text(size = 12),
...
p3 <-ggplot(MEI_AB, aes(ANO,UF )) +
  ...
  scale_fill_gradient(low = "white", high = "yellowgreen") +
  labs(title="Mapa de Calor - Empresas Abertas", subtitle="Empresas do MEI - Período: 2020") +  
  ylab("Estado") +
  xlab("Ano da Abertura") +
  theme(legend.title = element_text(size = 10),
        legend.text = element_text(size = 12),
